                        ...
                        @foreach($products as $product)
                            <li class="list-group-item d-flex justify-content-between lh-condensed">
                                <div>
                                    ...
                                    <small class="text-muted">{{trans('checkout.price')}}: <b>{{$product['price']}}</b></small>
                                    <small class="text-muted">{{trans('checkout.count')}}: <b>{{$product['qty']}}</b></small>
                                </div>
                    ...
                    <form class="needs-validation entrance__form" novalidate="">
                        ...
                        <div class="d-block my-3">
                            <div class="custom-control custom-radio">
                                <input id="pickup" name="shippingType" type="radio" class="custom-control-input" checked="" required="">
                                <label class="custom-control-label" for="pickup">{{trans('checkout.pickup')}}</label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input id="courier" name="shippingType" type="radio" class="custom-control-input" required="">
                                <label class="custom-control-label" for="courier">{{trans('checkout.courier-service')}} </label>
                            </div>
                        </div>
                        ...
                        <div class="d-block my-3">
                            <div class="custom-control custom-radio">
                                <input id="delivery" name="paymentType" type="radio" class="custom-control-input" checked="" required="">
                                <label class="custom-control-label" for="delivery">{{trans('checkout.payment.delivery')}}</label>
                            </div>
                            <div class="custom-control custom-radio">
                                <input id="online" name="paymentType" type="radio" class="custom-control-input" required="">
                                <label class="custom-control-label" for="online">{{trans('checkout.payment.online')}} </label>
                            </div>
                        </div>
                        <hr class="mb-4">
